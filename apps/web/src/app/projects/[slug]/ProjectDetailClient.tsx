...
export default function ProjectDetailClient({ project, prev, next, detail: remoteDetail }: ProjectDetailClientProps) {
  const detail = remoteDetail ?? projectDetails[project.slug] ?? projectDetails['cipher-shield'];
