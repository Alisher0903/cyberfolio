...
export function SkillsPanel({ skills, category }: { skills: Record<string, readonly string[]>; category: string }) {
  const meta = skillCategoryMeta[category as keyof typeof skillCategoryMeta] ?? skillCategoryMeta.Other;
